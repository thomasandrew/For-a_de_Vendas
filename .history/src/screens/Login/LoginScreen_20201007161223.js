...
export default function LoginScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, {backgroundColor: darkMode ? darkTheme.body : lightTheme.body}]}>
      <View style={[styles.centerAlign, { height: "100%", backgroundColor: darkMode ? darkTheme.body : lightTheme.body }]}>
        <Image
      ...
      <View
        style={[
          styles.centerAlign,
          { backgroundColor: darkMode ? darkTheme.body : lightTheme.body, height: height },
        ]}
      >
